class TestStepSet < ApplicationRecord
  ...
  belongs_to :base_test_step_set, class_name: 'TestStepSet', foreign_key: 'base_test_step_set_id', inverse_of: :inherited_test_step_sets
  ...
  def same_test_step_set?(other)
    ...
    base_test_step_set_id == other.base_test_step_set_id ||
      base_test_step_set_id == other.id ||
      other.base_test_step_set_id == id
  end
end
